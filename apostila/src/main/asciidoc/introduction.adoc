...
Essa capítulo teve como objetivo de dar o ponta pé inicial para os bancos de dados não relacionais, foram discutidos conceitos, os tipos de bancos que existem até o momento além das suas estruturas. Com esse novo paradigma de persistência vem novas possibilidades e novos desafios para as aplicações. Esse tipo de banco de dados veio para enfrentar a nova era das aplicações da qual velocidade ou o menor tempo de resposta possível é um grande diferencial. Com esse capítulo introdutório o leitor estará apto para seguir desbravando com os bancos não relacionais com o Cassandra.Essa capítulo teve como objetivo de dar o ponta pé inicial para os bancos de dados não relacionais, foram discutidos conceitos, os tipos de bancos que existem até o momento além das suas estruturas. Com esse novo paradigma de persistência vem novas possibilidades e novos desafios para as aplicações. Esse tipo de banco de dados veio para enfrentar a nova era das aplicações da qual velocidade ou o menor tempo de resposta possível é um grande diferencial. Com esse capítulo introdutório o leitor estará apto para seguir desbravando com os bancos não relacionais com o Cassandra.